...
#include <memory>
#include "../../GobangClient/chessboard.h"
...
QT_MOC_LITERAL(3, 21, 6), // "winner"
QT_MOC_LITERAL(4, 28, 16), // "TurnToNextPlayer"
QT_MOC_LITERAL(5, 45, 6), // "player"
QT_MOC_LITERAL(6, 52, 12), // "StartNewGame"
QT_MOC_LITERAL(7, 65, 8), // "SetPiece"
QT_MOC_LITERAL(8, 74, 1), // "x"
QT_MOC_LITERAL(9, 76, 1), // "y"
QT_MOC_LITERAL(10, 78, 4), // "Undo"
QT_MOC_LITERAL(11, 83, 5) // "steps"

    },
    "ChessBoard\0GameOver\0\0winner\0"
    "TurnToNextPlayer\0player\0StartNewGame\0"
    "SetPiece\0x\0y\0Undo\0steps"
};
...
void ChessBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->TurnToNextPlayer((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->StartNewGame(); break;
        case 3: _t->SetPiece((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChessBoard::GameOver)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ChessBoard::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChessBoard::TurnToNextPlayer)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ChessBoard::GameOver(int _t1)
{
...
// SIGNAL 1
void ChessBoard::TurnToNextPlayer(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
