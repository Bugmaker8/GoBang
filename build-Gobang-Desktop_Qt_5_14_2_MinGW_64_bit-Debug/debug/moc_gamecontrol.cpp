...
#include <memory>
#include "../../GobangClient/gamecontrol.h"
...
QT_MOC_LITERAL(1, 12, 12), // "ReturnToMenu"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 10), // "GameIsOver"
QT_MOC_LITERAL(4, 37, 6), // "winner"
QT_MOC_LITERAL(5, 44, 16), // "BlackTimerUpdate"
QT_MOC_LITERAL(6, 61, 16), // "WhiteTimerUpdate"
QT_MOC_LITERAL(7, 78, 8), // "GameOver"
QT_MOC_LITERAL(8, 87, 15), // "AiNextDropPiece"
QT_MOC_LITERAL(9, 103, 6) // "player"

    },
    "GameControl\0ReturnToMenu\0\0GameIsOver\0"
    "winner\0BlackTimerUpdate\0WhiteTimerUpdate\0"
    "GameOver\0AiNextDropPiece\0player"
};
...
void GameControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->BlackTimerUpdate(); break;
        case 3: _t->WhiteTimerUpdate(); break;
        case 4: _t->GameOver((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->AiNextDropPiece((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameControl::ReturnToMenu)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameControl::GameIsOver)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void GameControl::ReturnToMenu()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void GameControl::GameIsOver(int _t1)
{
